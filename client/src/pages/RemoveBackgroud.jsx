...
const RemoveBackgroud = () => {
  ...
  const onSubmitHandler = async (e)=>{
      ...
      try {
        // limit
        if(limit >=10){
          toast.error('You have a maximum of 10 credits to explore premium features such as image generation, background removal, and object removal. These limitations are in place because the demo relies on free-tier APIs.');
          return
        }
        setPremiumLimit()
        setLoading(true);
